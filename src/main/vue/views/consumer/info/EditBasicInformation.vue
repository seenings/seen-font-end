        ...
        <van-col span="22">
          ...
          <van-row title="婚姻状况" @click="onClickMaritalStatusEdit()">
            ...
            <van-col :span="14" class="seen-right">
              <van-row>
                <van-col :span="23">
                  {{ MaritalStatus.key(basicInformation.maritalStatus) }}
                </van-col>
                <van-col :span="1">
                  <van-icon name="arrow"/>
                </van-col>
        ...
        <van-col span="22">
          <van-row title="最高学历" @click="onClickHighestEducationEdit()">
            ...
            <van-col :span="14" class="seen-right">
              <van-row>
                <van-col :span="23">
                  {{ Education.key(educationAndWork.highestEducation) }}
                </van-col>
                <van-col :span="1">
                  <van-icon name="arrow"/>
                </van-col>
...
import {API_DICT} from "../../../../ts/http/dict-service-api.ts";
import {API_PUBLIC} from "../../../../ts/http/public-service-api.ts";
import {Education} from "../../../../ts/model/consumer/school/Education.ts";
import {
  MaritalStatus,
  UserUtils,
} from "../../../../ts/model/consumer/user-info/Sex.ts";
import {StatusCode} from "../../../../ts/model/sys/api-result.ts";
import type {CascaderString} from "../../../../ts/model/sys/option.ts";
import {CitiesUtils} from "../../../../ts/util/cities-util.ts";
import {SchoolUtils} from "../../../../ts/util/consumer/school/school-util.ts";
import {DateUtil} from "../../../../ts/util/date-util.ts";
import {MapUtils} from "../../../../ts/util/map-util.ts";
import {RecordUtils} from "../../../../ts/util/record-util.ts";
...
const basicInformation = ref<BasicInformation>({
  ...
  stature: 0,
  weight: 0,
  maritalStatus: MaritalStatus["未婚"],
